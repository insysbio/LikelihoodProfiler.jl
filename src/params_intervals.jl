...
struct ParamInput
    ...
    id::Int # id of the parameter for analysis
    ...
    max_iter::Int # maximum function evaluations
...
struct ParamInterval
    ...
    count_evals::Array{Int, 1} # count of loss_func calls
...
"""
    params_intervals(init_params::Vector{Float64}, id::Int,
...
- `max_iter::Int`: maximum `loss_func` evaluations (default `10^5`).
