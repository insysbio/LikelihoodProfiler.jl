...
function build_profile_solution(plprob::ProfileLikelihoodProblem, prof_data, elapsed_time)
  ProfileLikelihoodSolution{typeof(plprob),typeof(prof_data)}(plprob, prof_data, elapsed_time)
end

function Base.show(io::IO, mime::MIME"text/plain", pv::ProfileLikelihoodSolution) 
