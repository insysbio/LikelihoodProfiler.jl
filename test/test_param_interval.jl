@testset "default options" begin
    ...
    @test res0[1].result[1].status == :BORDER_FOUND_BY_FTOL
    @test res0[1].result[2].status == :BORDER_FOUND_BY_FTOL
    ...
    @test res0[2].result[1].status == :BORDER_FOUND_BY_FTOL
    @test res0[2].result[2].status == :BORDER_FOUND_BY_FTOL
