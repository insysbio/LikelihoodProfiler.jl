...
@test_throws DimensionMismatch ProfileLikelihoodProblem(optprob1, [0.,0, 0.], t1) 
@test_throws ArgumentError ProfileLikelihoodProblem(optprob1, [0.,0],  t1; threshold = -1)
@test_throws ArgumentError ProfileLikelihoodProblem(optprob1, [0.,0],  t2)


#plprob = ProfileLikelihoodProblem(optprob1, [0.,0], t1)
