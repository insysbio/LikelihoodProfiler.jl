...
@testset "testing get_optimal() for :LD_MMA and f_2p, nonidentifiable, finite" begin
    res0 = get_optimal(
        [4., 1., 1.],
        f_2p;
        silent = true,
...
@testset "testing get_optimal() for :LD_MMA and f_2p, nonidentifiable, autodiff" begin
    res0 = get_optimal(
        [4., 1., 1.],
        f_2p;
        silent = true,
