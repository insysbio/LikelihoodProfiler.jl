...
@testset "f_3p_1im" begin
    @test all(@. isapprox(res_f_3p_1im[1].intervals, [1.0, 5.0], atol=res_f_1p.input.ptol))
...
@testset "f_4p_2im" begin
    @test all(@. isapprox(res_f_4p_2im[1].intervals, [1.0, 5.0], atol=res_f_1p.input.ptol))
    ...
    @test all(@. isapprox(res_f_4p_2im[2].intervals, [2.0, 6.0], atol=res_f_1p.input.ptol))
...
@testset "f_4p_3im" begin
    @test all(@. isapprox(res_f_4p_3im[1].intervals, [1.0, 5.0], atol=res_f_1p.input.ptol))
